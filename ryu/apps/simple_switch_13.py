...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def multidatapathswitch_register(self, dp, enter_leave=True):
        ...
        for port in dp.ports:
            ...
            print  "\t",port.hw_addr, "\t", port.name, "\t",port.port_no, "\t",
            print  True if "gre" in port.name else ""
    ...
    def _packet_in_handler(self, ev):
        ...
        #if in_port not in self.dpid_to_control_port[dpid]:
        ...
        # prevent loop when have more than one switch
        print "dpi", 86698658679374, "==", dpid
        #if in_port == 2 and 86698658679374 == dpid:
        #    return
